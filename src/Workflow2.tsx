...
import { Trash2, Plus, Workflow, Zap, Globe, Settings, X, Sparkles, Search, Check, ArrowLeft, Eye, Play, MoreHorizontal, Undo2, Redo2, Maximize2 } from 'lucide-react';
      ...
      <div className="flex flex-1 overflow-hidden">
                    ...
                    {colorOptions.map(color => (
                      <button
                        ...
                        className={`h-10 rounded-lg transition-all duration-200 border-2 ${
                          customColor === color.value ? 'border-gray-800 scale-105' : 'border-gray-200 hover:scale-105'
                        }`}
        ...
        <div className="w-80 bg-white border-r border-gray-200 flex flex-col shadow-sm">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-gray-600 text-sm mt-2">Drag & drop to create powerful workflows</p>
          </div>
          ...
          <div className="p-6 flex-1 overflow-y-auto">
            ...
            <button
              ...
              className="w-full mt-6 p-4 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white rounded-xl font-medium transition-all duration-200 hover:scale-105 flex items-center justify-center gap-2 shadow-lg"
            >
              <Plus size={16} />
              Create Custom Node
            </button>
        ...
        <div className="flex-1 relative bg-gray-100 overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage: `
                ...
                linear-gradient(0deg, transparent 24%, rgb(243 244 246 / 0.3) 25%, rgb(243 244 246 / 0.3) 26%, transparent 27%, transparent 74%, rgb(243 244 246 / 0.3) 75%, rgb(243 244 246 / 0.3) 76%, transparent 77%, transparent),
                linear-gradient(90deg, transparent 24%, rgb(243 244 246 / 0.3) 25%, rgb(243 244 246 / 0.3) 26%, transparent 27%, transparent 74%, rgb(243 244 246 / 0.3) 75%, rgb(243 244 246 / 0.3) 76%, transparent 77%, transparent)
              `,
          ...
          >
            ...
            {nodes.map(node => (
              <div
                key={node.id}
                className={`absolute w-55 h-35 rounded-xl shadow-lg transition-all duration-200 select-none z-20 ${
                ...
                style={{
                  ...
                  height: '140px',
                  background: 'white',
                  border: `2px solid ${selectedNodeId === node.id ? '#3b82f6' : '#e5e7eb'}`
                }}
                onClick={(e) => {
                  e.stopPropagation();
              ...
              >
                ...
                {/* Body with ports */}
                <div className="p-4 h-28 flex justify-between items-center relative bg-gray-50">
                  {/* Input ports */}
            ...
            {nodes.length === 0 && (
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-gray-500 max-w-md">
                  ...
                  <h3 className="text-xl font-bold text-gray-700 mb-2">Create Your First Workflow!</h3>
                  <p className="text-gray-500 mb-6">Drag templates from the sidebar or add agents from the right panel</p>
            ...
            {isConnecting && connectionStart && (
              <div className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-700 text-sm shadow-lg z-50">
                <div className="flex items-center gap-2">
